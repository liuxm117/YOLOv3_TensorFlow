...
### Some paths
train_file = './train_b.txt'  # The path of the training txt file.
val_file = './val_b.txt'  # The path of the validation txt file.
restore_path = '/mnt/huojian/liuxin/liuxin/YOLOv3_TensorFlow/data/darknet_weights/yolov3.ckpt'  # The path of the weights to restore.
save_dir = './checkpoint_b_es/'  # The directory of the weights to save.
log_dir = './logs_b_es/'  # The directory to store the tensorboard log files.
progress_log_path = './progress_b_es.log'  # The path to record the training progress.
anchor_path = './blothole_anchors.txt'  # The path of the anchor txt file.
class_name_path = './blothole.names'  # The path of the class names.
